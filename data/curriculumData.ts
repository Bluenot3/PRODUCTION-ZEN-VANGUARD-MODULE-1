  ...
  sections: [
    {
      ...
      content: [
        ...
        },
        {
          type: 'paragraph',
          content:
            "Welcome to ZEN AI VANGUARD. We are witnessing the most significant shift in technology since the internet. Traditional software was about writing rules. AI is about teaching machines to learn. Before you write a single prompt, explore how this paradigm has shifted over the decades."
        },
        {
            type: 'interactive',
            content: '',
        ...
        {
            type: 'paragraph',
            content: "AI isn't magic; it's a pipeline of data processing. Hover over the steps below to see the journey from raw data to intelligence."
        },
        {
            type: 'interactive',
            content: '',
